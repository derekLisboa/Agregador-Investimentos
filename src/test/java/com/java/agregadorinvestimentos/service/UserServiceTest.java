...
public class UserServiceTest {
    ...
    class getUserById{
        ...
        @Test
        @DisplayName("Should get user by id with success when optiona is present")
       ...
       @Test
        @DisplayName("Should get user by id with success when optiona is empty")
    ...
    class deleteById{
        ...
        @Test
        @DisplayName("Should not delete userwhen user NOT exists")
        void shouldNotDeleteUseWhenUserNotExists(){
            // Arrange
    ...
    class updateById{
        ...
        void shouldUpdateUserByIdWhenUsernameAndPasswordIsFilled(){
